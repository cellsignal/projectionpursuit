...
_PNG_FILENAME = 'png/' + fn_in_train + '_' + left + right + 'match_asymmetric_no_black.png'
_MATCH_RESULT_FILENAME = 'match_result/' + fn_in_train + '_' + left + right + 'match_result_asymmetric_no_black.csv'
_MISCLASSIFICATION_FILENAME = 'misclassification/' + fn_in_train + '_' + left + right + 'misclassification_asymmetric_no_black.txt'
_RUN_STATS_FILENAME = 'run_stats/' + fn_in_train + '_' + left + right +  'run_stats_asymmetric_no_black.txt'
