...
_PNG_FILENAME = 'png/' + fn_in + '_' + left + right + 'match_asymmetric.png'
_MATCH_RESULT_FILENAME = 'match_result/' + fn_in + '_' + left + right + 'match_result_asymmetric.csv'
_MISCLASSIFICATION_FILENAME = 'misclassification/' + fn_in + '_' + left + right + 'misclassification_asymmetric.txt'
