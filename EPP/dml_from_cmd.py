...
fn_in_test = 'results/results_' + fn_in_train

fn_out_1 = 'dml/ground_truth_' + fn_in_train + '.csv'
fn_out_2 = 'dml/phenograph_' + fn_in_train + '.csv'
fn_out_3 = 'dml/projection_pursuit_' + fn_in_train + '.csv'
fn_score = 'dml/score_' + fn_in_train + '.txt'
