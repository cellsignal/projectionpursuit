...
_PNG_FILENAME = 'png/' + fn_in_train + '_' + left + right + 'match.png'
_PNG_CLUSTER_FILENAME = 'png/' + fn_in_train + '_' + left + right + 'clusters.png'
_MATCH_RESULT_FILENAME = 'match_result/' + fn_in_train + '_' + left + right + 'match_result.csv'
_MISCLASSIFICATION_FILENAME = 'misclassification/' + fn_in_train + '_' + left + right + 'misclassification.txt'
...
def main(unused_argv):
    ...
    sc = ax.scatter(*train_data.T, s=0.3, c=colors_train_2, cmap='Spectral', alpha=1.0)
    plt.setp(ax, xticks=[x_min, x_max, (x_max - x_min) / 4000], yticks=[y_min, y_max, (y_max - y_min) / 4000])
    ...
    sc = ax.scatter(*test_data.T, s=0.3, c=colors_test_2, cmap='Spectral', alpha=1.0)
    plt.setp(ax, xticks=[x_min, x_max, (x_max - x_min) / 4000], yticks=[y_min, y_max, (y_max - y_min) / 4000])
