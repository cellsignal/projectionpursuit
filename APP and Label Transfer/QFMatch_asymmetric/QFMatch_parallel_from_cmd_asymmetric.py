...
The script executes many clusters-to-one cluster matching with QFMatch between
...
_LEFT_FILENAME = 'dml/' + left + fn_in_train + '.csv'
_RIGHT_FILENAME = 'dml/' + right + fn_in_train + '.csv'
_PNG_FILENAME = 'png/' + fn_in_train + '_' + left + right + 'match_asymmetric.png'
_MATCH_RESULT_FILENAME = 'match_result/' + fn_in_train + '_' + left + right + 'match_result_asymmetric.csv'
_MISCLASSIFICATION_FILENAME = 'misclassification/' + fn_in_train + '_' + left + right + 'misclassification_asymmetric.txt'
_RUN_STATS_FILENAME = 'run_stats/' + fn_in_train + '_' + left + right +  'run_stats_asymmetric.txt'
                    ...
                    for cl in left_list_int:
                        if c_train == cl:
                            ...
                            if misclassification > 0:
                                ...
                                right_name_must_be = right_names[i + 1]
                            else:
                                left_name = left_names[i]
                                right_name_must_be = right_names[i]
                            if is_cell_misclassified:
                                color_train = 0
                            else:
                                color_train = i + 1
